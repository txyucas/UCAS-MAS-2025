...
from configs.config import CnnConfig
import torch
...
if __name__ == "__main__":
    ...
    # 在主函数中，先创建config类的实例，再创建PPO_Agent类的实例
    myconfig = CnnConfig()

    agent1 = PPO_Agent(myconfig)
    # 可以添加其他agent
    ...
    for i in range(1):
        ...
        while not done:
            ...
            if agent_num == 2:
                action1, action2 = agent1.act(obs[0]), rand_agent.act(obs[1])
