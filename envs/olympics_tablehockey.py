...
from olympics_engine.scenario.table_hockey import *
...
class OlympicsTablehockey(Game):
    def __init__(self, conf, seed=None):
        super(OlympicsTablehockey, self).__init__(conf['n_player'], conf['is_obs_continuous'], conf['is_act_continuous'],
